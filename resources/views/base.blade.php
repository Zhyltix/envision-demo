        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
            ...
            <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                ...
                <div class="app-sidebar-navs flex-column-fluid py-6" id="kt_app_sidebar_navs">
                    <div id="kt_app_sidebar_navs_wrappers" class="hover-scroll-y my-2" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_header, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_navs" data-kt-scroll-offset="5px" style="height: 616px;">
                        <!--begin::Quick links-->
                        <div class="menu menu-rounded menu-column">
                            ...
                            <div class="menu-item">
                                <!--begin::Menu link-->
                                <a href="{{ route('stations') }}" class="menu-link">
                                    <!--begin::Icon-->
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <!--begin::Menu link-->
                                <a href="{{ route('analyse') }}" class="menu-link">
                                    <!--begin::Icon-->
                                    <span class="menu-icon">
                        ...
                        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="menu menu-column menu-rounded menu-sub-indention menu-active-bg">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <span class="menu-link">
											...
											<span class="menu-title">Administratie</span>
											<span class="menu-arrow"></span>
										</span>
                                <!--end:Menu link-->
                                <!--begin:Menu sub-->
                                <div class="menu-sub menu-sub-accordion" kt-hidden-height="129" style="display: none; overflow: hidden;">
                                    <!--begin:Menu item-->
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="../../demo27/dist/utilities/modals/general/invite-friends.html">
                                            ...
                                            <span class="menu-title">Abbonnementen</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <div class="menu-item">
                ...
                <div class="app-sidebar-footer d-flex flex-stack px-11 pb-10" id="kt_app_sidebar_footer">
                    ...
                    <div class="">
                        ...
                        <div class="cursor-pointer symbol symbol-circle symbol-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
                            <img src="{{ asset('media/avatars/300-2.jpg') }}" alt="image">
                        </div>
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{ asset('media/avatars/300-13.jpg') }}">
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                    ...
                    <!--end::User menu-->
                    <!--begin::Logout-->
                    <a href="../../demo27/dist/authentication/flows/basic/sign-in.html" class="btn btn-sm btn-outline btn-flex btn-custom px-3">
